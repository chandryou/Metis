...
ps_model <- CohortMethod::getPsModel(
    propensityScore =
        readRDS(file.path(outputFolder, "Ps_l1_p1_t1124300_c1118084.rds")),
    cohortMethodData = CohortMethod::loadCohortMethodData(file.path(outputFolder, "CmData_l1_t1124300_c1118084")))
